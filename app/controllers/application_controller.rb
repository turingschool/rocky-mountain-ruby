class ApplicationController < ActionController::Base
  ...
  def index
    ...
    @speakers = [
      ...
      {name: 'Kinsey Ann Durham', bio: 'Kinsey is a software engineer at GoSpotCheck here in Denver. She is the co-founder of Kubmo, a non-profit dedicated to building and teaching technology curriculum to young women around the world. She is the chair of the BridgeFoundry board and organizes the Scholars and Guides Programs for Ruby Central conferences.', img: 'speakers/kinsey-ann-durham.jpg'},
      {name: 'Jackie Ros', subtitle: 'Community Spotlight', bio: 'Can wearable IoT devices make us safer? Jackie founded Revolar to find out. She brings perspective and lessons learned from getting the product to market, accelerating the business through Techstars, and helping build the Denver community.', img: 'speakers/jackie-ros.jpg'},

      {name: 'Announcing 7/1', bio: 'Appreticeship is changing the software industry. She instructs one of the most successful apprenticeship programs, help people develop real-world skills, and builds the technical community in Detroit.', img: 'default-speaker.jpg'},
      ...
      {name: 'Announcing 7/1', bio: 'She started a movement of the most supportive community of programmers and people learning to code. ', img: 'default-speaker.jpg'},
      # {name: Saron Yitbarek}

      {name: 'Announcing 7/8', subtitle: 'Community Spotlight', bio: 'Can we use data to fix the labor market? Across industries, there are many open jobs and many people under-employed or unemployed. We help great people get the training to start great careers.', img: 'default-speaker.jpg'},
      # {name: 'Skillful People'}

      {name: 'Announcing 7/8', bio: 'Experienced software engineer who co-founded RailsBridge and now is working to fix government with 18F', img: 'default-speaker.jpg'},
      # {name: 'Sarah Allen'}

      {name: 'Announcing 7/8', bio: "A long-time Ruby developer, community builder, and team leader - he's lived through Six-Sigma, a flagging unicorn startup, and finally small business success.", img: 'default-speaker.jpg'}
      # {name: 'Chad Fowler'}
    ]
